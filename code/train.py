...
def train(args):
  ...
  if DEV_SET is True:
    ...
    train_dataset = load_data(TRAIN_SET, PREPROCESSED, NER_TAG, BINARY)
    dev_dataset = load_data("../dataset/train/eval_0.8.csv", PREPROCESSED, NER_TAG, BINARY) # validation용 데이터는 따로 만드셔야 합니다.
